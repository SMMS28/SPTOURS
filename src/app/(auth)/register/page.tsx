...
import { signInWithGoogle, signInWithMagicLink, signUp } from "@/lib/actions/auth";

export const metadata = { title: "Create Account | SP Tours & Travels" };
    ...
    <div className="relative isolate flex min-h-screen items-center justify-center -mt-28 px-4 sm:-mt-32 lg:-mt-36">
      ...
      <HeroSlideshow
        images={[
          ...
          "/images/hero-bg/pexels-chunry-6538013.jpg",
          "/images/hero-bg/pexels-debphotography-4938600.jpg"
        ]}
      />
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="rounded-3xl border border-white/20 bg-white/10 p-8 shadow-[0_32px_64px_-24px_rgba(0,0,0,0.6)] backdrop-blur-xl">
          <h1 className="text-2xl font-bold text-white [text-shadow:0_1px_12px_rgba(0,0,0,0.6)]">Create your account</h1>
          <p className="mt-1 text-sm text-white/70">Sign up to save favourites and track inquiries.</p>
          ...
          <form action={signUp} data-confirm-message="Confirm account creation?" className="mt-6 space-y-4">
          ...
          <div className="mt-5 text-center text-sm text-white/60">
            <p>
              ...
              <Link href="/login" className="font-medium text-[#f29a2e] hover:underline">Sign in</Link>
            </p>
          </div>
        </div>
      </div>
