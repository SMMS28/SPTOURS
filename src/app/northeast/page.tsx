...
export default function NorthEastPage() {
  return (
    <div className="pb-20">
      {/* ── Hero ───────────────────────────────────────────────────────────── */}
      <section className="relative isolate -mt-28 flex min-h-[78vh] items-end overflow-hidden sm:-mt-32 lg:-mt-36">
        <Image
        ...
        <div className="relative mx-auto w-full max-w-7xl px-4 pb-20 pt-44 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="max-w-3xl"
          >
            <motion.p variants={reveal} className="text-sm font-semibold uppercase tracking-[0.22em] text-[#f29a2e] [text-shadow:0_1px_8px_rgba(0,0,0,0.6)]">
              SP Tours & Travels presents
            </motion.p>
            <motion.h1
              variants={reveal}
              className="mt-3 text-4xl font-bold leading-tight text-white sm:text-5xl lg:text-6xl [text-shadow:0_2px_24px_rgba(0,0,0,0.8)]"
            >
              North East India <br />
              <span className="text-yellow-300">Tour Packages</span>
            </motion.h1>
            ...
            <motion.div variants={reveal} className="mt-8 flex flex-wrap gap-4">
              <motion.div whileHover={{ y: -3 }}>
                <Link href="/contact" className="inline-flex h-12 items-center justify-center rounded-full bg-[#f29a2e] px-8 text-base font-semibold text-white transition hover:bg-[#e4891f]">
                  Plan My Trip
                </Link>
              </motion.div>
              <motion.div whileHover={{ y: -3 }}>
        ...
        >
          {[
            ...
            <motion.div
              key={s.label}
              variants={reveal}
              className="rounded-2xl border border-border/75 bg-card/80 p-5 text-center shadow-[0_8px_22px_-16px_rgba(15,23,42,0.18)] backdrop-blur-md"
            >
      ...
      <section className="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          animate="visible"
        >
          <motion.p variants={reveal} className="text-xs font-semibold uppercase tracking-[0.22em] text-primary">The Destination</motion.p>
          <motion.h2 variants={reveal} className="mt-2 text-3xl font-bold text-foreground sm:text-4xl">
            Where India&apos;s Wildest Landscapes Meet Its Richest Cultures
          </motion.h2>
          <motion.p variants={reveal} className="mt-4 max-w-3xl text-base leading-relaxed text-muted-foreground">
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <motion.div variants={reveal} initial={false} animate="visible">
          <p className="text-xs font-semibold uppercase tracking-[0.22em] text-primary">Why us</p>
          <h2 className="mt-2 text-3xl font-bold text-foreground">Why Travel the Northeast with SP Tours?</h2>
        </motion.div>
        <motion.div
          variants={stagger}
          initial={false}
        ...
        >
          {whyChoose.map((item) => (
            <motion.div
              key={item.title}
              variants={reveal}
              className="rounded-2xl border border-border/75 bg-card/80 p-5 shadow-[0_8px_22px_-16px_rgba(15,23,42,0.12)] backdrop-blur-md transition hover:border-primary/30 hover:shadow-[0_12px_28px_-16px_rgba(29,78,216,0.18)]"
            >
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <motion.div variants={reveal} initial={false} animate="visible">
          <p className="text-xs font-semibold uppercase tracking-[0.22em] text-primary">Destinations</p>
          <h2 className="mt-2 text-3xl font-bold text-foreground">Popular Destinations to Explore</h2>
        </motion.div>
        <motion.div
          variants={stagger}
          initial={false}
        ...
        >
          {destinations.map((dest) => (
            <motion.div
              ...
              className="group overflow-hidden rounded-3xl border border-border/75 bg-card shadow-[0_8px_32px_-16px_rgba(15,23,42,0.18)]"
            >
              <div className="relative h-52 overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 p-4">
                  <p className="text-xs font-semibold text-[#f29a2e]">{dest.tagline}</p>
                  <h3 className="mt-0.5 text-xl font-bold text-white [text-shadow:0_1px_8px_rgba(0,0,0,0.8)]">{dest.name}</h3>
                </div>
              </div>
              <div className="p-4">
                <p className="text-sm leading-relaxed text-muted-foreground">{dest.desc}</p>
                <Link href="/packages" className="mt-3 inline-block text-sm font-semibold text-primary hover:underline underline-offset-4">
                  View packages →
                </Link>
              </div>
            </motion.div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <motion.div variants={reveal} initial={false} animate="visible">
          <p className="text-xs font-semibold uppercase tracking-[0.22em] text-primary">Must-visit places</p>
          <h2 className="mt-2 text-3xl font-bold text-foreground">Iconic Stops on Every Northeast Journey</h2>
        </motion.div>
        <motion.div
          variants={stagger}
          initial={false}
        ...
        >
          {mustVisit.map((spot) => (
            <motion.div
              key={spot.name}
              variants={reveal}
              className="rounded-2xl border border-border/75 bg-card/80 p-5 shadow-[0_4px_18px_-10px_rgba(15,23,42,0.12)] backdrop-blur-md"
            >
              <div className="flex items-start justify-between gap-3">
                <div>
                  <h3 className="text-base font-semibold text-foreground">{spot.name}</h3>
                  <p className="text-xs font-medium text-primary">{spot.state}</p>
                </div>
                <span className="shrink-0 rounded-full border border-border bg-secondary px-3 py-1 text-xs font-medium text-secondary-foreground">
                  Best: {spot.bestTime}
                </span>
              </div>
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">{spot.highlight}</p>
              <dl className="mt-3 grid grid-cols-2 gap-2 text-xs">
                <div>
                  <dt className="text-muted-foreground/70">Permit</dt>
                  <dd className="mt-0.5 font-medium text-foreground">{spot.permit}</dd>
                </div>
                <div>
                  <dt className="text-muted-foreground/70">Activities</dt>
                  <dd className="mt-0.5 font-medium text-foreground">{spot.activities}</dd>
                </div>
              </dl>
            </motion.div>
          ))}
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <motion.div variants={reveal} initial={false} animate="visible">
          <p className="text-xs font-semibold uppercase tracking-[0.22em] text-primary">Travel calendar</p>
          <h2 className="mt-2 text-3xl font-bold text-foreground">When to Visit the Northeast</h2>
        </motion.div>
        <motion.div
          variants={stagger}
          initial={false}
        ...
        >
          {seasons.map((s) => (
            <motion.div
              key={s.period}
              variants={reveal}
              className="rounded-2xl border border-border/75 bg-card/80 p-6 shadow-[0_8px_22px_-16px_rgba(15,23,42,0.12)] backdrop-blur-md"
            >
              <div className="flex items-center justify-between gap-3">
                <span className="text-2xl font-bold text-foreground">{s.period}</span>
                <span className={`rounded-full border px-3 py-1 text-xs font-semibold ${s.badgeClass}`}>
                  {s.badge}
                </span>
              </div>
              <p className="mt-1 text-xs text-muted-foreground">Avg: {s.temp}</p>
              <h3 className="mt-3 text-sm font-semibold text-foreground">{s.headline}</h3>
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <motion.div variants={reveal} initial={false} animate="visible">
          <p className="text-xs font-semibold uppercase tracking-[0.22em] text-primary">Experiences</p>
          <h2 className="mt-2 text-3xl font-bold text-foreground">Unforgettable Things to Do</h2>
        </motion.div>
        <motion.div
          variants={stagger}
          initial={false}
        ...
        >
          {activities.map((act) => (
            <motion.div
              key={act.title}
              variants={reveal}
              className="rounded-2xl border border-border/75 bg-card/80 p-5 shadow-[0_4px_18px_-10px_rgba(15,23,42,0.12)] backdrop-blur-md transition hover:border-primary/30 hover:shadow-[0_12px_28px_-16px_rgba(29,78,216,0.18)]"
            >
              <span className="text-3xl">{act.icon}</span>
              <h3 className="mt-3 text-base font-semibold text-foreground">{act.title}</h3>
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <motion.div variants={reveal} initial={false} animate="visible">
          <p className="text-xs font-semibold uppercase tracking-[0.22em] text-primary">Getting here</p>
          <h2 className="mt-2 text-3xl font-bold text-foreground">How to Reach the Northeast</h2>
        </motion.div>
        <motion.div
          variants={stagger}
          initial={false}
        ...
        >
          <motion.div variants={reveal} className="rounded-2xl border border-border/75 bg-card/80 p-6 shadow-[0_4px_18px_-10px_rgba(15,23,42,0.12)] backdrop-blur-md">
            <h3 className="text-lg font-semibold text-foreground">✈️ By Air — Fastest Way</h3>
            <p className="mt-2 text-sm text-muted-foreground">Direct domestic flights from Delhi, Mumbai, Kolkata & Bangalore. International connections from Bangkok, Singapore & Paro (Bhutan).</p>
            <div className="mt-4 space-y-2">
              {airports.map((a) => (
                <div key={a.city} className="rounded-xl border border-border/60 bg-secondary/40 px-4 py-3">
                  <p className="text-sm font-semibold text-foreground">{a.city}, {a.state}</p>
          ...
          <div className="flex flex-col gap-5">
            <motion.div variants={reveal} className="rounded-2xl border border-border/75 bg-card/80 p-6 shadow-[0_4px_18px_-10px_rgba(15,23,42,0.12)] backdrop-blur-md">
              <h3 className="text-lg font-semibold text-foreground">🚂 By Train — Scenic & Budget-Friendly</h3>
              <p className="mt-2 text-sm text-muted-foreground">Major railheads: Guwahati, New Jalpaiguri, Dimapur, Dibrugarh, Agartala—connected to all major Indian cities.</p>
              <ul className="mt-4 space-y-2 text-sm">
                <li><span className="font-semibold text-foreground">Saraighat Express</span> <span className="text-muted-foreground">— Howrah → Guwahati (~18 hrs)</span></li>
                <li><span className="font-semibold text-foreground">Dibrugarh Rajdhani</span> <span className="text-muted-foreground">— New Delhi → Dibrugarh (~37 hrs)</span></li>
                <li><span className="font-semibold text-foreground">Kanchanjunga Express</span> <span className="text-muted-foreground">— Sealdah → Agartala (~37 hrs)</span></li>
              </ul>
            </motion.div>
            <motion.div variants={reveal} className="rounded-2xl border border-border/75 bg-card/80 p-6 shadow-[0_4px_18px_-10px_rgba(15,23,42,0.12)] backdrop-blur-md">
              <h3 className="text-lg font-semibold text-foreground">🚗 By Road — Best for Experience</h3>
              <p className="mt-2 text-sm text-muted-foreground">Scenic state highways connect the Northeast&apos;s major hubs. Popular routes:</p>
              ...
              <p className="mt-3 text-xs font-medium text-accent">💡 For remote spots like Ziro or Mawlynnong, book local cabs in advance.</p>
            </motion.div>
          </div>
        </motion.div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <motion.div variants={reveal} initial={false} animate="visible">
          <p className="text-xs font-semibold uppercase tracking-[0.22em] text-primary">Food & flavour</p>
          <h2 className="mt-2 text-3xl font-bold text-foreground">What to Eat in the Northeast</h2>
          <p className="mt-2 text-base text-muted-foreground">Each state is a distinct culinary universe—here are the unmissable dishes.</p>
        </motion.div>
        <motion.div
          variants={stagger}
          initial={false}
        ...
        >
          {cuisine.map((item) => (
            <motion.div
              key={item.dish}
              variants={reveal}
              className="rounded-2xl border border-border/75 bg-card/80 p-4 shadow-[0_4px_18px_-10px_rgba(15,23,42,0.10)] backdrop-blur-md"
            >
              <p className="text-xs font-semibold uppercase tracking-wider text-primary">{item.state}</p>
              <h3 className="mt-1 text-base font-semibold text-foreground">{item.dish}</h3>
      ...
      <section className="relative isolate mx-auto max-w-7xl overflow-hidden rounded-3xl px-4 py-0 sm:px-6 lg:px-8">
        <div className="relative isolate overflow-hidden rounded-3xl">
          ...
          >
            <motion.h2 variants={reveal} className="text-3xl font-bold text-white sm:text-4xl [text-shadow:0_2px_16px_rgba(0,0,0,0.7)]">
            ...
            <motion.div variants={reveal} className="mt-8 flex flex-wrap justify-center gap-4">
              <motion.div whileHover={{ y: -3 }}>
                <Link href="/contact" className="inline-flex h-12 items-center justify-center rounded-full bg-[#f29a2e] px-10 text-base font-semibold text-white transition hover:bg-[#e4891f]">
